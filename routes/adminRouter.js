...
router.get('/sales-data',adminAuth,adminController.getSalesChartData)
router.get('/test-data',adminAuth,adminController.testData)
router.get('/test-orders',adminAuth,adminController.testOrders)
